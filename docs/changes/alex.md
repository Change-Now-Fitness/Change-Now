...
Advance and merge the unit testing branch: merge the ‘unit test’ branch.

Advance and merge the bug-fix branch: merge the ‘find-a-small-error-in-exerciselibrary-file-after-unit-testing’ branch.
